    ...
    function fetchInitialData() {
        ...
        try {
            fetch('/data/image-manifest.json')
                ...
                .then(m => { window.__imageManifest = m; })
                .catch(() => { window.__imageManifest = null; });
        } catch (err) {
        ...
        fetch('/api/products')
            ...
            .catch(err => {
                ...
                if (container) {
                    container.innerHTML = '<p class="error-message">Could not load products at this time. Please try refreshing the page.</p>';
                }
            });
